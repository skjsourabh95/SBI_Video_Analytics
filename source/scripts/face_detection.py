...
def analysis(video_path,db_path, model_name = 'VGG-Face', detector_backend = 'opencv', distance_metric = 'cosine', enable_face_analysis = True, time_threshold = 5, frame_threshold = 5):
	...
	cap = cv2.VideoCapture(video_path) #webcam
...
if __name__ == "__main__":
    analysis(
	'../sample_data/face1.mp4', # '../sample_data/face1.mp4',
	'../database', 
	model_name = 'VGG-Face', 
